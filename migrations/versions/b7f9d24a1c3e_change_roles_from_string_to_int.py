...
def upgrade():
    ...
    with op.batch_alter_table("users") as batch_op:
        ...
        batch_op.alter_column("role_level", new_column_name="role")


def downgrade():
    op.add_column("users", sa.Column("role_string", sa.String(20), nullable=False))
    ...
    with op.batch_alter_table("users") as batch_op:
        batch_op.drop_column("role")
        batch_op.alter_column("role_string", new_column_name="role")
