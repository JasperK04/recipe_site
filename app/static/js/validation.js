(function () {
    ...
    document.addEventListener("submit", async (event) => {
        // Other form features (such as the image cropper) can cancel a submit
        // while they finish their work.  Do not turn that cancelled submit into
        // an AJAX request: doing so could save the recipe once before the user
        // confirms the crop and again afterwards.
        ...
        // A second submit event can be generated by a quick double-tap or by
        // mobile browsers while the first request is still pending.  One form
        // submission must result in at most one API request.
        if (apiForm.dataset.submitting === "1") {
            return;
        }
        apiForm.dataset.submitting = "1";
        ...
        try {
            ...
            delete apiForm.dataset.submitting;
            submitButtons.forEach((button) => {
